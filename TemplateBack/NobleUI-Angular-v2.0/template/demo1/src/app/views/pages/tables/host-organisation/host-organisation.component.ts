...
@Component({
  selector: 'app-host-organisation',
  templateUrl: './host-organisation.component.html',
  styleUrls: ['./host-organisation.component.scss']
})
export class HostOrganisationComponent implements OnInit {
  closeResult: string;
  content:any;
  photoLink:any; 
...
allHosts:any;
  ...
  constructor(config: NgbModalConfig, private modalService: NgbModal , private adminService : AdminService) {
    ...
    this.adminService.getHostsOrg().subscribe(data=>{
     this.list = data; 
