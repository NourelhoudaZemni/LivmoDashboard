...
@Component({
  selector: 'app-verified-host',
  templateUrl: './verified-host.component.html',
  styleUrls: ['./verified-host.component.scss']
})
export class VerifiedHostComponent implements OnInit {
...
allHosts:any;
  ...
  constructor(config: NgbModalConfig, private modalService: NgbModal , private adminService : AdminService) {
    ...
    this.adminService.getVerifiedHosts().subscribe(data=>{
     this.list = data; 
